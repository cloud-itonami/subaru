...
(defn collection
  [name]
  (str "com.etzhayyim.subaru." name))

(def cell-specs {
  :link-budget {:legacy-cell "cell-subaru-link-budget"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "link-budget")]
     :required-gates common-gates
     :trigger "manifest cell link-budget"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :coverage {:legacy-cell "cell-subaru-coverage"
     :phase :event
     :murakumo-node "reuben"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :stewardship {:legacy-cell "cell-subaru-stewardship"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "stewardship")]
     :required-gates common-gates
     :trigger "manifest cell stewardship"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :datom-emit {:legacy-cell "cell-subaru-datom-emit"
     :phase :event
     :murakumo-node "reuben"
